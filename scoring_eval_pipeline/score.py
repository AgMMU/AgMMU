...
with open('scoring_eval_pipeline/examples_s1.json') as file:
    examples_s1 = json.load(file)
with open('scoring_eval_pipeline/examples_s2.json') as file:
    examples_s2 = json.load(file)
with open('scoring_eval_pipeline/few_word_examples.json') as file:
        ...
        try:
            for llm in q['llm_answers']:
                if 'mcq' in llm:
                    ...
                    print("SCORE", q['llm_answers'][llm]['score'])
